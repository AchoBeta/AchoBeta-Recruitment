...
public enum GlobalServiceStatusCode {
    ...
    RESOURCE_LOAD_FAILED(7007, "资源加载失败"),
    RESOURCE_PREVIEW_FAILED(7008, "资源预览失败"),
    RESOURCE_DOWNLOAD_FAILED(7009, "资源下载失败"),
    RESOURCE_GET_OBJECT_URL_FAILED(7010, "获取资源 url 失败"),
    RESOURCE_NOT_VALID(7011, "资源非法"),
    RESOURCE_IS_BLANK(7012, "资源为空"),
    RESOURCE_OUT_SIZE(7013, "资源过大"),
